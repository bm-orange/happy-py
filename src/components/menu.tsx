      ...
      <div className="flex flex-col md:flex-row w-full gap-4 md:gap-8 items-center justify-center">
        ...
        <div className="w-full max-w-md md:max-w-96 rounded-4xl md:rounded-2xl shadow-2xl bg-white p-6 text-center cursor-pointer" onClick={() => handleNav(2)}>
          <div className="bg-blue-100 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4">
            <i className="w-8 h-8">
              <svg viewBox="-0.16 0 20.32 20.32" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <g id="font-2" transform="translate(-2 -2)"> <path id="primary" d="M4,21,12,3l8,18" fill="none" stroke="#155dfc" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path> <path id="primary-2" data-name="primary" d="M20,21,12,3,4,21" fill="none" stroke="#155dfc" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path> <line id="primary-3" data-name="primary" x2="7.5" y2="16.87" transform="translate(11.5 4.13)" fill="none" stroke="#155dfc" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></line> <path id="primary-4" data-name="primary" d="M7,15H17M6,21H3m14,0h4" fill="none" stroke="#155dfc" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path> </g> </g></svg>
            </i>
          </div>
            ...
            {['b', 'a', 'o'].map((v, i) => {
              return (
                <div key={i} className="w-16 h-16 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center">
                  <span className="mono-font font-bold text-4xl">{v}</span>
                </div>
              )
            })}
          </div>
